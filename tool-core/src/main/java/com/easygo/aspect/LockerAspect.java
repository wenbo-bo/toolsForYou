...
import com.easygo.annotation.Locker;
import com.easygo.utils.CommonUtils;
import com.easygo.utils.RedisLockUtil;
import com.easygo.utils.ReflectHelper;
import com.easygo.utils.RequestUtils;
import com.easygo.utils.thread.Threads;
...
public class LockerAspect {
    ...
    @Pointcut("@annotation(com.easygo.annotation.Locker)")
