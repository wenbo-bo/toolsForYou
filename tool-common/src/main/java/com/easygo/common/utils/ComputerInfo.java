...
public abstract class ComputerInfo {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("MAC:"+ComputerInfo.getMacAddress());
        System.out.println(ComputerInfo.getMacAddress().hashCode());
        System.out.println("主机名:"+ComputerInfo.getComputerName());
        System.out.println("ip地址:"+ComputerInfo.getIpAddr());
        System.out.println("ip地址名:"+ComputerInfo.getIpAddrAndName());
    }
}
