package com.easy.go.service.impl;
 ...
 **/
public abstract class DictSVImpl implements IDictSV {
     ...
     */
    @Override
    public <T> Map<T, String> getDictValues(Class<?> dictCode, Class<T> keyType) {
        Map<T, String> map = new LinkedHashMap<>();
        Map<String, String> dictValues = this.getDictValues(dictCode.getSimpleName());
